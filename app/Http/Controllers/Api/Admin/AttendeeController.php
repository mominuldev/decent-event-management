                            ...
                            new OAT\Property(
                                ...
                                items: new OAT\Items(
                                    properties: [
                                        ...
                                        new OAT\Property(property: 'nid_number', type: 'string', description: 'NID or birth registration number. Always present for an admin token; the unauthenticated public registration response omits it.', nullable: true),
                                        ...
                                        new OAT\Property(property: 'current_section', type: 'string', nullable: true),
                                        new OAT\Property(property: 'current_roll', type: 'string', nullable: true),
            ...
            content: new OAT\MediaType(
                ...
                schema: new OAT\Schema(
                    properties: [
                        ...
                        new OAT\Property(property: 'post_office', type: 'string', nullable: true, maxLength: 100),
                        new OAT\Property(property: 'upazila', type: 'string', nullable: true, maxLength: 100),
                        new OAT\Property(property: 'address_district', type: 'string', nullable: true, maxLength: 80),
                        new OAT\Property(property: 'date_of_birth', type: 'string', format: 'date', nullable: true),
                        new OAT\Property(property: 'nid_number', type: 'string', description: 'NID or birth registration number; 10, 13, 16 or 17 digits.', nullable: true),
                        ...
                        new OAT\Property(property: 'ssc_batch_year', type: 'integer', nullable: true),
                        new OAT\Property(property: 'current_class', type: 'string', enum: ['6', '7', '8', '9', '10'], nullable: true),
                        new OAT\Property(property: 'current_section', type: 'string', maxLength: 32, nullable: true),
                        new OAT\Property(property: 'current_roll', type: 'string', maxLength: 16, nullable: true),
