...
class TicketTypeController extends Controller
{
                            ...
                            new OAT\Property(
                                ...
                                items: new OAT\Items(
                                    properties: [
                                        ...
                                        new OAT\Property(property: 'base_price_tk', type: 'integer', description: 'Amount in paisa (1 BDT = 100 paisa)'),
                                        new OAT\Property(property: 'additional_adult_price_tk', type: 'integer', description: 'Amount in paisa'),
                                        new OAT\Property(property: 'additional_child_price_tk', type: 'integer', description: 'Amount in paisa'),
                                        new OAT\Property(property: 'current_student_price_tk', type: 'integer', nullable: true, description: 'Amount in paisa, or null when this type has no student rate.'),
            ...
            content: new OAT\MediaType(
                ...
                schema: new OAT\Schema(
                    properties: [
                        ...
                        new OAT\Property(property: 'name_bn', type: 'string', nullable: true),
                        new OAT\Property(property: 'description', type: 'string', nullable: true),
                        new OAT\Property(property: 'base_price_tk', type: 'integer', description: 'Amount in paisa (1 BDT = 100 paisa)', required: ['base_price_tk']),
                        new OAT\Property(property: 'additional_adult_price_tk', type: 'integer', description: 'Amount in paisa', required: ['additional_adult_price_tk']),
                        new OAT\Property(property: 'additional_child_price_tk', type: 'integer', description: 'Amount in paisa', required: ['additional_child_price_tk']),
                        new OAT\Property(property: 'current_student_price_tk', type: 'integer', nullable: true, description: 'Amount in paisa. What a current student pays for their own seat; null means they pay base_price_tk.'),
            ...
            content: new OAT\MediaType(
                ...
                schema: new OAT\Schema(
                    properties: [
                        ...
                        new OAT\Property(property: 'name_bn', type: 'string', nullable: true),
                        new OAT\Property(property: 'description', type: 'string', nullable: true),
                        new OAT\Property(property: 'base_price_tk', type: 'integer', description: 'Amount in paisa. Locked after sales start.'),
                        new OAT\Property(property: 'additional_adult_price_tk', type: 'integer', description: 'Amount in paisa. Locked after sales start.'),
                        new OAT\Property(property: 'additional_child_price_tk', type: 'integer', description: 'Amount in paisa. Locked after sales start.'),
                        new OAT\Property(property: 'current_student_price_tk', type: 'integer', nullable: true, description: 'Amount in paisa. Locked after sales start.'),
    ...
    public function update(UpdateTicketTypeRequest $request, TicketType $ticketType): TicketTypeResource|JsonResponse
    {
        ...
        if ($ticketType->quantity_sold > 0) {
            $restrictedKeys = ['code', 'base_price_tk', 'additional_adult_price_tk', 'additional_child_price_tk', 'current_student_price_tk'];
