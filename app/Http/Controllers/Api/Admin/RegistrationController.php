            ...
            content: new OAT\MediaType(
                ...
                schema: new OAT\Schema(
                    ...
                    properties: [
                        ...
                        new OAT\Property(property: 'full_name_bn', type: 'string', maxLength: 150, nullable: true, description: 'Optional since 2026-09-13; falls back to full_name wherever it is rendered.'),
                        ...
                        new OAT\Property(property: 'nid_number', type: 'string', description: 'NID or birth registration number; 10, 13, 16 or 17 digits; optional.', nullable: true),
                        ...
                        new OAT\Property(property: 'post_office', type: 'string', maxLength: 100),
                        new OAT\Property(property: 'upazila', type: 'string', maxLength: 100),
                        ...
                        new OAT\Property(property: 'current_class', type: 'string', enum: ['6', '7', '8', '9', '10'], nullable: true, description: 'Required when participant_type is current_student.'),
