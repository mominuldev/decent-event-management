...
return [
    ...
    'share' => [
        'heading' => 'বন্ধুদের জানান — আমি থাকছি!',
        'caption' => 'ছবিটি চেপে ধরে সংরক্ষণ করুন, তারপর ফেসবুক বা হোয়াটসঅ্যাপে পোস্ট করুন। এতে কোনো কিউআর কোড নেই, তাই নিশ্চিন্তে শেয়ার করা যায়।',
        'alt' => ':name-এর "আমি থাকছি!" কার্ড',
    ],
